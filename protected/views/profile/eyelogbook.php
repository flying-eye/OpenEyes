...
<div class="box admin">
	...
	<?php echo $form->passwordField($eyelogbook_account, 'password', array('readonly' => !Yii::app()->params['profile_user_can_edit'], 'placeholder' => 'leave blank to enter password everytime', 'class' => 'eyelogbook_input')) ?>
	...
	<?php if (Yii::app()->params['profile_user_can_edit']) { ?>
		...
		<div class="row field-row">
			<div class="large-5 large-offset-2 column">
				<div class="alert-box with-icon" style="display: none;"></div>
			</div>
		</div>
	<?php } ?>
...
"$('.eyelogbook_input').change(function(){
